    ...
    <header className="relative h-96 md:h-[500px] text-white">
      ...
      <div className="relative z-20 flex flex-col items-center justify-center h-full text-center px-4">
        <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight leading-tight mb-4" style={{textShadow: '2px 2px 4px rgba(0,0,0,0.7)'}}>
          <span className="text-yellow-300">2025년 한국부동산마케팅협회</span><br/><span className="text-yellow-300">회장배</span> 골프대회
        </h1>
        <p className="text-lg md:text-2xl font-medium mb-2" style={{textShadow: '1px 1px 2px rgba(0,0,0,0.7)'}}>
          주최: 한국부동산마케팅협회
        </p>
